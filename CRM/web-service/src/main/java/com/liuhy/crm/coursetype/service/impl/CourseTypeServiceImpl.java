...
public class CourseTypeServiceImpl implements CourseTypeService {
    ...
    @Override
    public PageBean<CrmCourseType> findAll(CrmCourseType courseType, int currentPage, int pageSize) {
        // 查询条件
        String constraints = "";
        // 参数
        List<Object> params = new ArrayList<Object>();
        ...
        return courseTypeDao.findAll(currentPage, pageSize, constraints, args);
    }
