...
<s:form namespace="/" action="classAction_upload" enctype="multipart/form-data">
    ...
    <table width="88%" border="0" class="emp_table" style="width:80%;">
        ...
        <tr>
            <td>上次上传时间：</td>
            <td>
                <s:date name="uploadTime" var="uploadTime1" format="yyyy-MM-dd" />
                <s:property value="uploadTime1"/>
            </td>
            <td>&nbsp;</td>
        </tr>
        <tr>
